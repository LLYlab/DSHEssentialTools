...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = "" +
      ...
      '.dset-modal{width:680px;max-width:88vw;max-height:84vh;display:flex;flex-direction:column;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border:1px solid var(--dsw-alias-border-l1);border-radius:12px;overflow:hidden;box-shadow:0 12px 40px rgba(0,0,0,.45)}' +
    ...
    function FileModal(props) {
      ...
      return React.createElement("div", { className: "dset-modal-mask", onClick: function () { if (!saving[0] && !approveOpen[0]) props.onClose(); } },
      ...
      var renderNode = function (node, depth) {
        if (node.type === "dir") {
          ...
          return React.createElement("div", { key: "d" + node.path },
            React.createElement("div", { className: "dset-tree-row dset-tree-dir" + (isOpen ? " dset-tree-row-open" : ""), style: { paddingLeft: String(12 + depth * 14) + "px" } },
