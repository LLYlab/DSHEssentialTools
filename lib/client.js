              ...
              : React.createElement(React.Fragment, null,
                  trunk[0]
                    ? React.createElement("div", {
                        ...
                        onClick: function () { setSelected("trunk"); },
                      },
                        React.createElement("span", { className: "dset-bview-item-title" }, "主线" + (selected[0] === "trunk" ? "（当前）" : "")),
                        React.createElement("span", { className: "dset-bview-item-sub" }, "无分支 · 整个会话"),
                        React.createElement("button", { className: "dset-branch-item-btn", disabled: true }, "当前")
                      )
                    : null,
                  branches[0].map(function (b) {
