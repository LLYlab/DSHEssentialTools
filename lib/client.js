...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    var CSS = "" +
      ...
      '.dset-vtd-editarea{width:100%;box-sizing:border-box;resize:none;overflow:hidden;background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-primary);border:1px solid var(--dsw-alias-brand-primary);border-radius:8px;padding:8px 10px;font:inherit;font-size:13px;line-height:1.5}' +
      ...
      // 精细渲染(Markdown-lite + 内容块)
      '.dset-md-code{background:var(--dsw-alias-bg-layer-2);border:1px solid var(--dsw-alias-border-l1);border-radius:6px;padding:8px 10px;overflow:auto;white-space:pre;font-family:inherit;font-size:12px;margin:4px 0}' +
      '.dset-md-reason{margin:4px 0;font-size:12px;color:var(--dsw-alias-label-secondary)}' +
      '.dset-md-reason summary{cursor:pointer;user-select:none;font-size:11px}' +
      '.dset-md-tool{margin:6px 0;border:1px solid var(--dsw-alias-border-l1);border-radius:8px;background:var(--dsw-alias-bg-layer-2);padding:6px 8px;font-size:12px}' +
      '.dset-md-tool-result{margin:2px 0 6px}' +
      '.dset-md-tool-err{border-color:var(--dsw-alias-state-error-primary)}' +
      '.dset-md-tool-head{display:flex;align-items:center;gap:6px;margin-bottom:4px}' +
      '.dset-md-tool-ico{flex:none;font-size:12px}' +
      '.dset-md-tool-name{font-weight:600;font-size:11.5px}' +
      '.dset-md-tool-id{color:var(--dsw-alias-label-secondary);font-size:10px;margin-left:auto}' +
      '.dset-md-args{white-space:pre-wrap;word-break:break-word;font-size:11.5px;color:var(--dsw-alias-label-secondary);margin:0;font-family:inherit}' +
      '.dset-vtd-bubble h1,.dset-vtd-bubble h2,.dset-vtd-bubble h3,.dset-vtd-bubble h4{font-size:12.5px;margin:6px 0 2px}' +
      '.dset-vtd-bubble p{margin:4px 0}' +
      '.dset-vtd-bubble ul,.dset-vtd-bubble ol{margin:4px 0;padding-left:18px}' +
      '.dset-vtd-bubble blockquote{margin:4px 0;padding-left:10px;border-left:2px solid var(--dsw-alias-brand-primary);color:var(--dsw-alias-label-secondary)}' +
      '.dset-vtd-bubble code{background:var(--dsw-alias-bg-layer-2);border-radius:4px;padding:0 3px;font-size:11.5px;font-family:inherit}' +
    ...
    function apply(ctx) {
      ...
      // VTD 对话树视图:独立标签(不替换产品"聊天");原对话保留为默认。
      ...
      // 产品"聊天"视图:用户气泡下 编辑/重试 + <N>(conversation.chat.user-actions 槽)
