    ...
    function DetManagerSection(props) {
      ...
      var rest = masterOn ? React.createElement("div", null,
        ...
        (function () {
          ...
          if (!info.pausedCount) return React.createElement("p", { className: "dset-sec-desc" }, "DET 管控的插件:关闭时没有任何插件处于启用状态,无需停用。");
          return React.createElement("div", { className: "dset-dbg-panel" },
            React.createElement("div", { className: "dset-gp-store-sub" }, "已随总开关停用的 DET 管控插件(" + info.pausedCount + " 个 · 重新打开总开关会自动恢复):"),
            info.paused.map(function (p) {
              return React.createElement("div", { key: p.id, className: "dset-dbg-row" },
                ...
                React.createElement("span", { className: "dset-dbg-tag" }, p.kind === "installed" ? "常驻已安装 · 已卸载" : (p.permanent ? "常驻 · 已卸载" : "会话实例已停")),
